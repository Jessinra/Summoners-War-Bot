...
class Activeuser():
    def __init__(self):
        ...
        self.s.verify = False
        self.s.headers.update({'Content-Type': 'text/html', 'Accept-Language': 'en-gb', 'User-Agent':'SMON_Kr/3.8.2.38200 CFNetwork/808.2.16 Darwin/16.3.0'})
...
class QPYOU(object):
    def __init__(self, did=None, phone=None):
        ...
        self.s.headers.update({'Content-Type': 'application/json', 'Accept-Language': 'en-gb',
                               'User-Agent': 'SMON_Kr/3.8.2.38200 CFNetwork/808.2.16 Darwin/16.3.0'})
        self.did = did
        self.guest_uid = None
